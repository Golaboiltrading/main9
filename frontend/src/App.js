                    ...
                    <div className="space-y-3">
                      ...
                      {selectedListing.contact_phone && (
                        <button
                          ...
                          className="w-full bg-green-500 hover:bg-green-400 text-white py-3 px-6 rounded-lg font-semibold text-lg transition-colors flex items-center justify-center"
                        >
